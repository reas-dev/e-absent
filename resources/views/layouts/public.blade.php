...
<body style="background-color: #dee9ff;">
    <div id="app">
        <nav class="navbar fixed-top navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/view_product') }}">
        ...
        <!-- PUBLIC NAVBAR -->
        <div class="navbar-top shadow">
            <div class="container">
                <div class="row">
                    <ul class="nav">
                        <li class="nav-item">
                            <a class="nav-link text-white" href="/view_product">Home</a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-pkkp" aria-labelledby="navCategory">
                                @foreach($categories as $cat)
                                <a class="dropdown-item text-white" href="/view_product/category/{{ $cat->category }}">{{ $cat->category }}</a>
                                @endforeach
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-pkkp" aria-labelledby="navCategory">
                                ...
                                <a class="dropdown-item text-white" href="/view_product/location/{{ $location->place }}">{{ $location->place }}</a>
                                @endforeach
                            </div>
                        </li>
                    </ul>
